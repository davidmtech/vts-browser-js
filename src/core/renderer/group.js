...
RenderGroup.prototype.getNodeLOD = function(node) {
    var lod = 0;
...
RenderGroup.prototype.getNodeTexelSize = function(node, screenPixelSize) {
...
RenderGroup.prototype.drawNodeVolume = function(points, color, node) {
...
RenderGroup.prototype.drawNode = function(node, noSkip, splitMask, splitSpace) {
...
RenderGroup.prototype.isMeshReady = function(job, doNotLoad, priority, skipGpu, skipStats, node) {
    var mesh = job.mesh;
    var submeshes = mesh.submeshes;
    var ready = true;
...
RenderGroup.prototype.getGpuSize = function(job) {
    var mesh = job.mesh;
...
RenderGroup.prototype.drawMesh = function(job ,node, splitMask, splitSpace) {
    var mesh = job.mesh;
    var submeshes = mesh.submeshes;
    var cameraPos = this.renderer.cameraPosition;
...
RenderGroup.prototype.generateNode = function(index, file, lod, cindex, texelSize, points, center, radius, hasMesh) {
...
RenderGroup.prototype.traverseBinNode = function(cindex, points, center, radius, texelSize, lod, index, file, visible, isready, skipRender) {
...
RenderGroup.prototype.getPath = function(tab, index) {
    var stmp = '';
    while(tab[index] != 0) {
...
RenderGroup.prototype.isBinNodeReady = function(points, center, index, file, doNotLoad, priority, skipGpu, skipStats) {
    var ready = true;
...
RenderGroup.prototype.getBinNodeTexelSize = function(pos, radius, screenPixelSize) {
    var cameraPos = this.renderer.cameraPosition;
    var d = vec3.length(
        [pos[0] - cameraPos[0],
         pos[1] - cameraPos[1],
...
RenderGroup.prototype.onBinFileLoaded = function(info, data) {
